  ...
  tabsetPanel(
    ...
    tabPanel("Utility analysis",
             ...
             selectInput("index_ref",
                         ...
                         choices = list("Choose one" = "",
                                        "Bison food SFUI (Emerson 1990)" = "ref_data/FoodSAVGFUI_Bison-Emerson90.csv",
                                        "Bison marrow & fat SAVGMAR (Emerson 1990)" = "ref_data/MarrowFatSAVGMAR_Bison-Emerson90.csv",
                                        "Bison total products SMAVGTP (Emerson 1990)" = "ref_data/FoodSMAVGTP_Bison-Emerson90.csv",
